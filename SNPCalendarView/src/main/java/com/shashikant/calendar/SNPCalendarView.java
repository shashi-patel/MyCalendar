...
public class SNPCalendarView extends LinearLayout{
	...
	ImageView imageview_previous, imageview_next;
	...
	public SNPCalendarView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}
	
	public SNPCalendarView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	void init(Context context){
		...
		view = li.inflate(R.layout.snp_calendarview, null, false);
		...
		imageview_next.setOnClickListener(new OnClickListener() {
	...
	public void setOnCalendarViewListener(onSNPCalendarViewListener c){
		calendarListener = c;
	}
	...
	public void setDate(String date){
		if (date.equals(SNPCalendarView.TODAY)) {
	...
	/**
	 * @param dates like this format: "2018-03-20"
	 * */
	...
	public void setEvents1(ArrayList<String> dates){
		calendaradapter.setItems1(dates);
		handler.post(calendarUpdater);
	}
	
	public void setEvents2(ArrayList<String> dates){
		calendaradapter.setItems2(dates);
		handler.post(calendarUpdater);
	}
}
